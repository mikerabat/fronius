...
begin
     ...
     for i := 0 to High(TCborDecoding.cborDecodeTbl) do
         TCborDecoding.cborDecodeTbl[i] := {$IFDEF FPC}@{$ENDIF}NotImplemented;

     // int
     for i := 0 to $17 do
         TCborDecoding.cborDecodeTbl[i] := {$IFDEF FPC}@{$ENDIF}DecodeTinyUInt;
     TCborDecoding.cborDecodeTbl[$18] := {$IFDEF FPC}@{$ENDIF}DecodeByte;
     TCborDecoding.cborDecodeTbl[$19] := {$IFDEF FPC}@{$ENDIF}DecodeWord;
     TCborDecoding.cborDecodeTbl[$1A] := {$IFDEF FPC}@{$ENDIF}DecodeLongWord;
     TCborDecoding.cborDecodeTbl[$1B] := {$IFDEF FPC}@{$ENDIF}DecodeUINT64;

     // neg int
     for i := $20 to $37 do
         TCborDecoding.cborDecodeTbl[i] := {$IFDEF FPC}@{$ENDIF}DecodeTinyNegInt;
     TCborDecoding.cborDecodeTbl[$38] := {$IFDEF FPC}@{$ENDIF}DecodeNegByte;
     TCborDecoding.cborDecodeTbl[$39] := {$IFDEF FPC}@{$ENDIF}DecodeNegWord;
     TCborDecoding.cborDecodeTbl[$3A] := {$IFDEF FPC}@{$ENDIF}DecodeNegLongWord;
     TCborDecoding.cborDecodeTbl[$3B] := {$IFDEF FPC}@{$ENDIF}DecodeNegUINT64;

     // strings
     for i := $40 to $57 do
         TCborDecoding.cborDecodeTbl[i] := {$IFDEF FPC}@{$ENDIF}DecodeShortString;
     TCborDecoding.cborDecodeTbl[$58] := {$IFDEF FPC}@{$ENDIF}DecodeMediumString;
     TCborDecoding.cborDecodeTbl[$59] := {$IFDEF FPC}@{$ENDIF}DecodeLongString;
     TCborDecoding.cborDecodeTbl[$5A] := {$IFDEF FPC}@{$ENDIF}DecodeLongLongString;
     TCborDecoding.cborDecodeTbl[$5B] := {$IFDEF FPC}@{$ENDIF}DecodeUINT64String;
     TCborDecoding.cborDecodeTbl[$5F] := {$IFDEF FPC}@{$ENDIF}DecodeChunkedString;

     // utf8
     for i := $60 to $77 do
         TCborDecoding.cborDecodeTbl[i] := {$IFDEF FPC}@{$ENDIF}DecodeUTF8ShortString;
     TCborDecoding.cborDecodeTbl[$78] := {$IFDEF FPC}@{$ENDIF}DecodeUTF8MediumString;
     TCborDecoding.cborDecodeTbl[$79] := {$IFDEF FPC}@{$ENDIF}DecodeUTF8LongString;
     TCborDecoding.cborDecodeTbl[$7A] := {$IFDEF FPC}@{$ENDIF}DecodeUTF8LongLongString;
     TCborDecoding.cborDecodeTbl[$7B] := {$IFDEF FPC}@{$ENDIF}DecodeUTF8UINT64String;
     TCborDecoding.cborDecodeTbl[$7F] := {$IFDEF FPC}@{$ENDIF}DecodeUTFChunkedString;

     // int list
     for i := $80 to $97 do
         TCborDecoding.cborDecodeTbl[i] := {$IFDEF FPC}@{$ENDIF}DecodeShortIntList;
     TCborDecoding.cborDecodeTbl[$98] := {$IFDEF FPC}@{$ENDIF}DecodeSmallIntList;
     TCborDecoding.cborDecodeTbl[$99] := {$IFDEF FPC}@{$ENDIF}DecodeMediumIntList;
     TCborDecoding.cborDecodeTbl[$9A] := {$IFDEF FPC}@{$ENDIF}DecodeLongIntList;
     TCborDecoding.cborDecodeTbl[$9B] := {$IFDEF FPC}@{$ENDIF}DecodeLongLongIntList;
     TCborDecoding.cborDecodeTbl[$9F] := {$IFDEF FPC}@{$ENDIF}DecodeChunkedIntList;

     // maps
     for i := $A0 to $B7 do
         TCborDecoding.cborDecodeTbl[i] := {$IFDEF FPC}@{$ENDIF}DecodeShortMap;
     TCborDecoding.cborDecodeTbl[$B8] := {$IFDEF FPC}@{$ENDIF}DecodeSmallIntMap;
     TCborDecoding.cborDecodeTbl[$B9] := {$IFDEF FPC}@{$ENDIF}DecodeMediumMap;
     TCborDecoding.cborDecodeTbl[$BA] := {$IFDEF FPC}@{$ENDIF}DecodeLongMap;
     TCborDecoding.cborDecodeTbl[$BB] := {$IFDEF FPC}@{$ENDIF}DecodeLongLongMap;
     TCborDecoding.cborDecodeTbl[$BF] := {$IFDEF FPC}@{$ENDIF}DecodeChunkedMap;

     for i := $E0 to $F3 do
         TCborDecoding.cborDecodeTbl[i] := {$IFDEF FPC}@{$ENDIF}DecodeTinySimpleVal;
     TCborDecoding.cborDecodeTbl[$F4] := {$IFDEF FPC}@{$ENDIF}DecodeTrueFalse;
     TCborDecoding.cborDecodeTbl[$F5] := {$IFDEF FPC}@{$ENDIF}DecodeTrueFalse;
     TCborDecoding.cborDecodeTbl[$F6] := {$IFDEF FPC}@{$ENDIF}DecodeNULL;
     TCborDecoding.cborDecodeTbl[$F8] := {$IFDEF FPC}@{$ENDIF}DecodeSimpleValue;
     TCborDecoding.cborDecodeTbl[$F9] := {$IFDEF FPC}@{$ENDIF}Decode16BitFloat;
     TCborDecoding.cborDecodeTbl[$FA] := {$IFDEF FPC}@{$ENDIF}DecodeFloat;
     TCborDecoding.cborDecodeTbl[$FB] := {$IFDEF FPC}@{$ENDIF}DecodeDouble;
end;
