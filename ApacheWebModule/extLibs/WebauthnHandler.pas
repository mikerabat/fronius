...
uses {$IFDEF MS_WINDOWS} Windows, {$ENDIF} syncObjs, strUtils, Classes,
     Fido2dll,
...
begin
     assert( FidoDataHandler <> nil, 'Error no data handler assigned');

     FidoDataHandler.SaveUserInitChallenge( self );
end;
